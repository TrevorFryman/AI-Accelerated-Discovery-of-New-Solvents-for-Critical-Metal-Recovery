"""
RDKit Descriptor Pipeline - Baseline XGBoost Model (v2, Final Model)

v2 of the original Track 2 train_rdkit_baseline.py, pointed at the
Final Model data/results layout. Superseded by optimize_rdkit_model_v2.py,
finetune_rdkit_nested_cv.py, and finalize_rdkit_model.py for the tuned
model and its evaluation; kept here as the default-hyperparameter
baseline for fair before/after comparison against the Morgan Fingerprint
and ChemBERTa pipelines.
