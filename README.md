...
This repository is for my summer of 2026 REU program at the University of Kentucky. The overall goal is to develop machine learning models to predict solvent properties and guide the selection of deep eutectic solvents for critical metal recovery. Please see the [Wiki](https://github.com/TrevorFryman/AI-Accelerated-Discovery-of-New-Solvents-for-Critical-Metal-Recovery/wiki) for more details on aspects of the project.

The project follows this simple process: 

ML Models —> Solvent Screening —> Experimental Validation

**File Organization:**

* mp_prediction-main contains a provided ML model from post-graduate student Kailong Zhang to help me get a basic grasp of an ML model. Furthermore, it contains the gathered data that was used to train the simple ML models to further my grasp on the project. 
