...
* green_solvents-main contains a dataset used to train the production-level ML model references in [[Predicting Solvent Greenness]] as well as the _GreenSolventDB_.
